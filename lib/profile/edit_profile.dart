...
import 'package:chatroom/profile/profile_page.dart';
...
class EditCreateProfileScreen extends StatefulWidget {
  const EditCreateProfileScreen({Key? key}) : super(key: key);

  @override
  State<EditCreateProfileScreen> createState() => _EditCreateProfileScreenState();
}

class _EditCreateProfileScreenState extends State<EditCreateProfileScreen> {
                      ...
                      child: Material(
                        ...
                        child: Ink.image(
                          image: _user.ImagePath.contains('https://')
                              ...
                              : FileImage(File(
                              _user.ImagePath)) as ImageProvider,
                          fit: BoxFit.cover,
                          width: 200,
                          height: 200,
